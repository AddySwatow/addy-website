...
function buildDeepAnalysisPrompt(personality) {
  ...
  return `你是职业规划顾问，为${type}型人格推荐职业方向。

人格：${type}（${typeNames[type]}型）

任务要求：
1. 推荐2个最适合的行业：用30-50字说明为什么适合，禁止用任何MBTI术语如倾向维度等，用具体工作场景描述
2. 推荐4个具体职业：匹配度百分比，用40-60字描述为什么匹配，禁止任何MBTI术语，用具体日常工作场景说明比如这个工作每天要做什么刚好这类人擅长什么
3. 社交：优势2条、挑战2条、建议2条，禁止任何MBTI术语

输出要求：
只返回纯JSON，禁止任何MBTI术语包括倾向维度内向外向思考情感判断感知等词汇

返回格式：
{"industries":[{"name":"企业管理","reason":"这个行业每天需要统筹团队制定计划执行方案这类人天生喜欢把事情安排井井有条看到项目一步步推进特别有成就感"},{"name":"教育培训","reason":"需要持续输出知识体系帮助他人成长这类人善于梳理归纳乐于把自己掌握的东西分享出去"}],"careers":[{"name":"项目经理","score":92,"reason":"这个工作每天要协调各部门推进进度解决突发问题刚好这类人喜欢把控全局遇到问题会立刻组织开会排查确保按时完成"},{"name":"行政主管","score":88,"reason":"需要处理大量流程文件保持办公室运转有序这类人天生喜欢整理归纳看到环境井井有条文件分类清晰就特别舒服"},{"name":"审计师","score":85,"reason":"每天核对数据发现问题提出整改这类人喜欢刨根问底看到数据不一致就会追问到底直到把问题找出来"},{"name":"人力资源经理","score":90,"reason":"要规划团队配置设计制度流程这类人善于搭建框架看到组织架构清晰人才梯队合理就特别满足"}],"social":{"strengths":["说话直爽不绕弯子让人信任","做事靠谱说到做到不拖延"],"challenges":["有时太直接可能伤到别人感情","不喜欢闲聊让人觉得不好接近"],"tips":["聊天的先关心对方再谈正事","偶尔参加轻松聚会放松一下"]}}`;
}
