...
返回JSON：{"EI":{"score":${dimensionStats.EI.percentage},"tendency":"${dimensionStats.EI.tendency}"},"SN":{"score":${dimensionStats.SN.percentage},"tendency":"${dimensionStats.SN.tendency}"},"TF":{"score":${dimensionStats.TF.percentage},"tendency":"${dimensionStats.TF.tendency}"},"JP":{"score":${dimensionStats.JP.percentage},"tendency":"${dimensionStats.JP.tendency}"},"finalType":"${finalType}","confidence":85,"description":"直接用第一人称生动描述这个人格的特点（约300-400字）：不要开头套话直接进入描述，把四个维度融合讲述，用具体场景和比喻，说出典型行为习惯和思维方式，避免学术术语用通俗表达，结尾点出独特魅力"}`;
}
